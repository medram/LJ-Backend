...
class StripeWebhookController extends WebhookController
{
    ...
    public function handle(Request $request)
    {
        ...
        if ($stripeEvent) {
            ...
            if ($stripeEvent->type == "invoice.paid") {
            ...
            } elseif ($stripeEvent->type == "customer.subscription.updated") {
                ...
                if ($user) {
                    ...
                    if ($subscription) {
                        ...
                        elseif (in_array($stripeSubscription->status, ["canceled", "ended"])) {
            ...
            } elseif ($stripeEvent->type == "customer.subscription.deleted") {
                $stripeSubscription = $stripeEvent->data->object;
                $user = User::find($stripeSubscription->metadata->customer_id);
            ...
            } elseif ($stripeEvent->type == "invoice.payment_failed") {
            ...
            elseif ($stripeEvent->type == "customer.subscription.trial_will_end") {
                # TODO: notify the client (probably via an email message)
                # $user->sendBillingNotificationEmail();
            }
